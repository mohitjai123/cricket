...
function ContactUs() {
  ...
  return (
    <section className=''>
      {/* <BreadCamp img={API_URL+"other-images/IMG_4449.JPG"} name={"Contacts"} /> */}
      <div className='lg:flex'>
        <FaqBox/>
        <iframe className='lg:w-1/2 w-full' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.014324905102!2d72.85394150554457!3d19.28263022993954!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b04c10d65839%3A0xad3f7fb04109a9d3!2sSAI%20ASHIYANA%20CHSL!5e0!3m2!1sen!2sin!4v1741751247929!5m2!1sen!2sin" height="450" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
...
const FormSection =()=>{
  ...
  return <section className='lg:flex py-20 gap-10 lg:px-24 px-3'>
        ...
        <h2 className='lg:text-5xl text-2xl my-4 font-semibold'>Have questions? <br className='max-lg:hidden' />
        Get in touch!</h2>
        <p className='text-gray-500'>We’d love to assist you with any questions or provide the information you need about MJPL Premier League. Whether you’re inquiring about registrations, trials, partnerships, or sponsorships, feel free to reach out to us
        </p>
          ...
          <p>B-3, Sai Ashiyana, Nr Aziziya Masjid, Mira Road (E), Mira Road, Mira Bhayander, Thane, Thane- 401107, Maharashtra, India
          </p>
          </div>
          <a href='tel: +91 7021612227' className='flex mt-5 gap-4'>
          ...
          <a href='mailto: info@macjhons.com' className='flex justify-center mt-5 w-fit group relative text-gray-500 hover:text-black duration-500 gap-4'>
        ...
        <div>
          ...
          <div className='lg:flex pb-8 max-lg:mt-8 w-full gap-8'>
          ...
          <div className='lg:flex relative gap-4'>
       ...
       <textarea placeholder='Message' rows={4} className="border-b-2 w-full outline-none focus:border-gray-800 duration-300 focus:placeholder:text-primary py-3 px-9" name="message" onChange={handleChange} value={formData.message} id=""></textarea>
        ...
        <div className='flex max-lg:flex-col-reverse mt-8 gap-5 items-center'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M20 5L4.672 11.373c-.395.164-.592.247-.643.354a.3.3 0 0 0 .016.29c.063.1.268.16.68.281L10.5 14M20 5l-2.065 13.049c-.04.254-.06.381-.127.45a.3.3 0 0 1-.223.097c-.097 0-.205-.072-.421-.216l-2.93-1.956M20 5l-9.5 9m0 0l.156 4.3c0 .334 0 .501.069.585c.06.074.15.116.246.115c.11-.001.24-.108.5-.32l2.764-2.256M10.5 14l3.735 2.424"></path></svg>
          ...
          I agree with the site's <a className='underline hover:text-primary duration-300 underline-offset-4' href="/privacy-policy">privacy policy</a>.
          </label>
          </div>
        </div>
          </form>
